...
class GameController extends GetxController {
  ...
  RxBool _turnBlue = true.obs;
  bool get turnBlue => _turnBlue.value; 

  void _buildBoard() {
    _turnBlue.value = true;
    board = [
      List.filled(6, 0),
      List.filled(6, 0),
      List.filled(6, 0),
  ...
  void playColumn(int columnNumber) {
    ...
    final int playerNumber = turnBlue ? 1 : 2;
    //* Select column
    final selectedColumn = board[columnNumber];

    if (selectedColumn == selectedColumn.last) {}
    ...
    if (selectedColumn.contains(0)) {
      ...
      //* Switch turns
      _turnBlue.value = !_turnBlue.value;
      //* Update UI
      update();
  ...
  void declareWinner() {
    Get.defaultDialog(
        ...
        title: winner == 1 ? 'Congress! BLUE WON' : 'Congress! RED WON',
        content: Cell(
          currentCellMode: winner == 1 ? cellMode.BLUE : cellMode.RED,
        ));
  }
